 ...
 * -----
 * Last Modified: Monday, December 12th 2022, 10:19:22 am
...
add_filter( 'aioseo_canonical_url', function( $canonical_url ) {
    ...
    // If the current page is a product or collection page, return empty to disable canonical URL.
