                ...
                <div class="eci-column">
                    <div class="eci-box eci-box-min-height">
                        ...
                        <header class="eci-box-header">
                            <h2 class="eci-box-title"><?php esc_html_e( 'Settings Instructions', 'wp-commerce7' ); ?></h2>
                        </header>
                            ...
                            <ul class="eci-box-features">
                                <li>
                                    ...
                                    <div class="eci-box-feature-info">
                                        <h4 class="eci-box-content-title"><?php esc_html_e( 'Add your tenant ID', 'wp-commerce7' ); ?></h4>
                                ...
                                <li>
                                    ...
                                    <div class="eci-box-feature-info">
                                        <h4 class="eci-box-content-title"><?php esc_html_e( 'Choose whether or not to enable the Cart Box', 'wp-commerce7' ); ?></h4>
                                        <span class="eci-box-content-text">
                                            <?php
                                ...
                                <li>
                                    ...
                                    <div class="eci-box-feature-info">
                                        <h4 class="eci-box-content-title"><?php esc_html_e( 'Choose the position of your Cart Box', 'wp-commerce7' ); ?></h4>
                                        <span class="eci-box-content-text">
                                            <?php
