( function( blocks, editor, element ) {
	...
	blocks.registerBlockType( 'c7wp/buy', {
        title: __( 'Buy Button (Single)' ), // The title of block in editor.
        description: __( 'Place an add to cart button with price and quantity fields for a single SKU.' ),
		icon: iconEl,
		...
		edit: function( props ) {
            ...
            return (
                el( 'div', {
                    ...
                    el( 'div', { 
                        className: 'c7-buy-variant',
                        'data-sku': props.attributes.data,
                        },
                        el(
                            'strong',
                            null,
                            'Buy Button for Single SKU'
                        ),
                        el(
                            'label',
                            null,
