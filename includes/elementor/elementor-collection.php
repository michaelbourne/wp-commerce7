 ...
 * -----
 * Last Modified: Thursday, September 3rd 2020, 8:02:14 pm
 ...
 * Widget class
 */
class C7WP_Elementor_Collection extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Collection', 'wp-commerce7' );
	}
	...
	public function get_keywords() {
		return [ 'commerce7', 'collection', 'products' ];
	}
	...
	protected function render() {
		...
		echo do_shortcode( '[c7wp type="collection" data="' . $data . '"]' );
