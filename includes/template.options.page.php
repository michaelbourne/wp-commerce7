            ...
            <div class="eci-row">
                <div class="eci-column">
                    <div class="eci-box">
                        ...
                        <img src="<?php echo C7WP_URI . '/assets/heroheader.png'; ?>" alt="Commerce7 for WordPress" style="max-width: 100%;" />
                ...
                <div class="eci-column">
                    <div class="eci-box eci-box-min-height">
                        ...
                        <header class="eci-box-header">
                            <h2 class="eci-box-title"><?php esc_html_e('Settings Instructions', 'commerce7-for-wordpress'); ?></h2>
                        </header>
                        ...
                        <div class="eci-box-content">
                            <ul class="eci-box-features">
                                ...
                                <li>
                                    ...
                                    <div class="eci-box-feature-info">
                                        <h4 class="eci-box-content-title"><?php esc_html_e('Choose whether or not to enable the Cart Box', 'commerce7-for-wordpress'); ?></h4>
                                        <span class="eci-box-content-text">
                                            <?php
                                            /* translators: Options page step 2.  */
                                            esc_html_e('The Cart Box will contain a magic login/logut link, as well as the cart totals and a link for the flyout shopping cart. You should disable it here if you would prefer to place the login/logout link and cart link in your header with the shortcodes below.', 'commerce7-for-wordpress');
                                            ?>
                                        </span>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="eci-box-feature-info">
                                        <h4 class="eci-box-content-title"><?php esc_html_e('Choose the position of your Cart Box', 'commerce7-for-wordpress'); ?></h4>
                                        <span class="eci-box-content-text">
                                            <?php
                                            /* translators: Options page step 3.   */
                                            esc_html_e('The Cart Box can be positioned to any corner of the screen to accomodate different design layouts. Try all of them to find your preferred placement.', 'commerce7-for-wordpress');
                                            ?>
                                        </span>
                                    </div>
                                </li>
        ...
        <div class="eci-sidebar">
            <div class="eci-row">
                <div class="eci-column">
                    <div class="eci-box">
                        <div class="eci-box-content">
                            <img src="<?php echo C7WP_URI . 'assets/newslettertitle.png'; ?>" alt="Get The Newsletter" style="max-width: 100%;" />
                ...
                <div class="eci-column">
                    <div class="eci-box">
                        <div class="eci-box-content ">
                            ...
                            <a href="https://demo.5forests.com" target="_blank" style="display: block; color:#fff; background: #333; text-align: center; padding: 1em; font-weight: bold; text-decoration: none; margin-top: 3em;">Read the Docs</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="eci-cta">
                <p class="eci-cta-note">Plugin created by URSA6 and 5FORESTS and is provided free to Commerce7 customers and WordPress Users.</p>
                <hr class="eci-cta-spacing">
                <p class="eci-cta-note">We recommend <a href="https://kinsta.com/?kaid=PBYVIJQKUDTT" tagret="_blank">Kinsta</a> managed hosting to our WordPress clients.</p>
            </div>
        </div>
