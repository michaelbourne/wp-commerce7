( function( blocks, editor, element ) {
	...
	blocks.registerBlockType( 'c7wp/createaccount', {
        title: __( 'Registration Form' ), // The title of block in editor.
        description: __( 'Place a registration form anywhere on your site.' ),
		icon: iconEl,
        category: 'commerce7', // The category of block in editor.
        keywords: [ 'commerce7', 'form', 'register', 'account' ],
        example: {},
		attributes: {
            data: {
                type: 'string',
                source: 'attribute',
                selector: '#c7-create-account',
