( function( blocks, editor, element ) {
	...
	blocks.registerBlockType( 'c7wp/quickshop', {
        title: __( 'Collection Quick Shop' ), // The title of block in editor.
        description: __( 'Place a condensed collection table on your page.' ),
		icon: iconEl,
        category: 'commerce7', // The category of block in editor.
        keywords: [ 'commerce7', 'collection', 'shop', 'quick' ],
        example: {},
		attributes: {
            data: {
                type: 'string',
                source: 'attribute',
                selector: '#c7-quick-shop',
